...
const SectionSkeleton = () => (
  <div className="py-24 max-w-7xl mx-auto px-6">
    <div className="w-full h-80 bg-surface/5 animate-pulse rounded-[40px] flex items-center justify-center border border-white/5">
      <div className="w-24 h-1 bg-primary-gold/20 rounded-full" />
    </div>
  </div>
);
  ...
  return (
    <main className="overflow-hidden relative">
      <Helmet>
        ...
        <meta name="twitter:title" content="Shorinji Kempo Marseille — Saint-Giniez | Art Martial & Self-Défense" />
        <meta name="twitter:description" content="Découvrez le Shorinji Kempo à Marseille 13008. Self-défense, arts martiaux et bien-être. Cours tous niveaux, essai gratuit." />
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-ivory-silk lg:text-ivory-silk/90 max-w-xl mb-10 text-lg md:text-2xl font-medium leading-relaxed mx-auto lg:mx-0 lg:[text-shadow:none] [text-shadow:0_2px_10px_rgba(0,0,0,1)] hero-description">
      ...
      <section className="py-48 bg-surface relative overflow-hidden border-y border-white/5">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center mb-20">
            ...
            <p className="text-slate-100 text-xl max-w-2xl mx-auto">Développez votre confiance et votre force dès les premières séances grâce à une méthode éprouvée.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              >
                ...
                <p className="text-slate-50 leading-relaxed text-lg font-medium">{benefit.desc}</p>
              </ScrollReveal>
            ))}
          </div>
      ...
      <section className="py-48 bg-bg-main relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-24">
            ...
            <p className="max-w-2xl mx-auto text-slate-900 text-xl">Que vous cherchiez la sérénité, la force ou la discipline, trouvez votre voie parmi nos sections dédiées.</p>
          </div>
            ...
            {[
              ...
              >
                ...
                <div className="flex-grow text-center">
                  ...
                  <p className={cn("mb-10 text-lg leading-relaxed", card.featured ? "text-ivory-silk/90" : "text-slate-900")}>{card.desc}</p>
                </div>
                <a 
                  href="/#contact"
                  className={cn(
          ...
          <ScrollReveal delay={0.4} className="mt-16 text-center">
            <Link 
              ...
              className="text-slate-500 text-xs md:text-sm hover:text-primary-gold transition-colors font-medium tracking-wide"
            >
              Découvrez notre dojo au cœur de Marseille Saint-Giniez
            </Link>
          </ScrollReveal>
        </div>
      </section>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
          <div className="flex flex-col lg:flex-row gap-20 items-start">
            <div className="lg:w-1/3 lg:sticky lg:top-32">
              ...
              <p className="text-slate-100 mb-8">Rejoignez l'élite du Budo au cœur de Marseille (13008).</p>
              <button 
